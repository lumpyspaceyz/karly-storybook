  ...
  return (
    <header className="mx-auto my-0 w-innerWrapper">
      ...
      <div className="header__div-top flex h-13 items-center justify-end">
        <a href="#" className="px-3 text-p-sm text-primary">회원가입</a>
        <div className="h-3.25 w-px border-r text-gray-divider" />
        <a href="#" className="px-3 text-p-sm text-content">로그인</a>
        <div className="h-3.25 w-px border-r text-gray-divider" />
      ...
      <div className="mb-3.25 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <a href="#" className="text-l-lg text-primary">마켓칼리</a>
          <div className="h-3.5 border-r text-gray-divider" />
          <a href="#" className="text-l-lg text-gray-400">뷰티칼리</a>
        </div>
        <div className="relative">
          <form>
            <input type="text" name="keyword" className="w-100 rounded border border-primary px-5 py-3 text-p-lg text-gray-400 focus:outline-primary" placeholder="검색어를 입력해주세요" />
            <button type="submit">
        ...
        <div className="relative flex gap-5">
          ...
          <div className="header__bubble absolute right-0 top-12 z-10 hidden h-[100px] w-[254px] animate-bubble-fadeIn border border-gray-200 bg-white p-5">
            <figure className="flex gap-5">
              ...
              <div>
                <figcaption className="header__bubble-figcaption mb-2 text-l-sm text-gray-300" />
      ...
      <div className="header__div-simple fixed left-0 right-0 top-0 z-20 hidden bg-white shadow-Below/Low" style={{ display: 'none' }}>
        <nav className="mx-auto my-0 flex h-18 w-innerWrapper items-center justify-between gap-2">
          ...
          <div className="relative">
            <input type="text" className="w-48.5 rounded border border-primary px-5 py-2 text-p-sm text-gray-400 focus:outline-primary" placeholder="검색어를 입력해주세요" />
            <button type="button">
